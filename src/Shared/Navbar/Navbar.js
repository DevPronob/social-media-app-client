  ...
  <div class="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
      <ul class="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
        <li class=""><Link to="/" class="text-gray-600 hover:text-blue-600" href="#">Home</Link></li>
        <li class=""><Link to="/media" class="text-gray-600 hover:text-blue-600" href="#">Media</Link></li>
        <li class=""><Link to="/message" class="text-gray-600 hover:text-blue-600" href="#">Message</Link></li>
        <li class=""><Link to="/about" class="text-gray-600 hover:text-blue-600" href="#">About</Link></li>
        <li>{user ? <button className="rounded-xl mt-[-3px] border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white" onClick={logout} >Sign Out</button> : <li class="mt-2 sm:mt-0"><Link class="rounded-xl border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 hover:bg-blue-600 hover:text-white" href="#">Login</Link></li>}</li>
